...
/**
 The base class for all wk2_weather modules
 */
...
/**
 wk2_weather Platform calls this method on startup.
 */
-(void)startup;

/**
 wk2_weather Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 wk2_weather Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 wk2_weather Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 wk2_weather Platform calls this method on resume.
 @param sender The sender of the event.
 */
