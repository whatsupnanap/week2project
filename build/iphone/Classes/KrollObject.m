...
//@interface wk2_weatherObject : NSObject
//@end

@interface wk2_weatherObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[wk2_weatherObject class]])
		{
			for (NSString *key in [[(wk2_weatherObject*)o modules] allKeys])
			{
