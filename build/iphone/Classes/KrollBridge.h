...
@interface wk2_weatherObject : KrollCoverageObject {
#else
@interface wk2_weatherObject : KrollObject {
#endif
@private
...
extern NSString * wk2_weather$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	wk2_weatherObject *_wk2_weather;
    KrollObject* console;
	BOOL shutdown;
