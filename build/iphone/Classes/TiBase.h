...
// in simulator we redefine to format for wk2_weather Developer console
...
{\
	NSString * exceptionName = [@"org.wk2_weather." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wk2_weather";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIwk2_weatherNativeItemNone = -1, 
	UIwk2_weatherNativeItemSpinner = -2,
	UIwk2_weatherNativeItemProgressBar = -3,
	
	UIwk2_weatherNativeItemSlider = -4,
	UIwk2_weatherNativeItemSwitch = -5,
	UIwk2_weatherNativeItemMultiButton = -6,
	UIwk2_weatherNativeItemSegmented = -7,
	
	UIwk2_weatherNativeItemTextView = -8,
	UIwk2_weatherNativeItemTextField = -9,
	UIwk2_weatherNativeItemSearchBar = -10,
	
	UIwk2_weatherNativeItemPicker = -11,
	UIwk2_weatherNativeItemDatePicker = -12,
	
	UIwk2_weatherNativeItemInfoLight = -13,
	UIwk2_weatherNativeItemInfoDark = -14,
	
	UIwk2_weatherNativeItemDisclosure = -15,
	
	UIwk2_weatherNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all wk2_weather instances of
