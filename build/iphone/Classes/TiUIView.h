...
/**
 Base class for all wk2_weather views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the wk2_weather view hierarchy (such as wrapped iOS UIViews) was touched.
